...
namespace Task_2
{
    public class Bank
    {
        ...
        public Bank(string full_name, string nationalID, int phonenumber, string address, int accountnumber)
        {
            _Fullname = full_name;
        ...
        public Bank(string full_name, string nationalID, int phonenumber, string address, int accountnumber, int balance):this (full_name,nationalID,phonenumber,address, accountnumber)
        {
            _Balance = balance;
        ...
        {
            Console.WriteLine($"name: {Fullname}, phone: {Phonenumber}, balance: {Balance}, address: {Address}, national ID: {NationalID}");
        }
